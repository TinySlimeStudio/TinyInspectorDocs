---
description: >-
  Splits properties into tabs within the same group, helping organize large sets
  of values into clean, logical sections.
icon: table-columns
---
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/Zrzut ekranu 2026-02-19 020340.png" alt=""><figcaption></figcaption></figure></div>
...
<mark style="color:$danger;background-color:$danger;">**REQUIRED**</mark> <mark style="color:$info;">string</mark> **TabName**\
<sup><mark style="color:$info;">Maximum value of the bar.<mark style="color:$info;"></sup>
